...
## The position between Drew and Hollywood — what makes it structurally available
...
## The Anthropic IPO timing as strategic input

Anthropic's IPO is the single biggest scheduled-but-undated AI news event of the next 18-24 months. When it happens:

- The S-1 filing alone releases internal financials, employee count, customer breakdown, revenue mix
- Karen Hao will likely write something definitive
- The Information, NYT, Bloomberg, WSJ run deep coverage
...
DeepSeek's January 20 2025 launch of R1 is:

- Fresh (less than 18 months ago)
- Visually striking (Hangzhou team room, NYSE opening bell, Nvidia's 17% single-day drop — biggest in history)
- Geopolitically charged (Chinese hedge-fund-backed lab outpacing US labs with fraction of budget)
...
**Cold open (90 seconds).** Hangzhou, January 20 2025, late night. Cinematic recreation of the DeepSeek office. The R1 release. A team that's been working in relative obscurity hits "publish." Then the camera moves: New York Stock Exchange opening bell, January 27. Nvidia's chart dropping 17% in real-time. $589 billion in market value evaporating in a single trading session — the largest single-day loss for any company in stock market history. Narrator: "On January 27 2025, a small Chinese lab that almost nobody outside AI research had heard of cost the most valuable chip company in human history more than half a trillion dollars in a single day. To understand how that became possible, we need to go back to a hedge fund in Hangzhou that had been quietly preparing for this moment since 2019."

**Act One — The Hedge Fund (2 min).** Liang Wenfeng's background. High-Flyer Capital Management. The 2019 decision to acquire AI talent and GPU compute "in case" they needed it. The pivot from quantitative trading to AI research. The 2023 founding of DeepSeek as a research lab spinoff. The thesis: efficient training matters more than raw compute.

**Act Two — The Wall (3 min).** US export controls on advanced chips to China (October 2022 and successive tightenings). The H800 limitation. The narrative that China was 5-10 years behind in AI. Sam Altman's now-infamous comments about competing on talent and capital. The strategic assumption underlying OpenAI's moat: nobody could catch up without billions in compute access.

**Act Three — The Innovation (3 min).** DeepSeek's technical breakthroughs through 2024. The mixture-of-experts architecture. Multi-token prediction. The training innovations that achieved frontier-model quality with reportedly $6M in compute (vs OpenAI's $100M+ on GPT-4). The December 2024 release of DeepSeek-V3. The signals most US researchers dismissed.

**Act Four — The Drop (4 min — centerpiece).** January 20 2025. The R1 release. The open-source license. The Hugging Face downloads. The Twitter cascade through that week as researchers tested and confirmed: this is real, this matches o1, this is built on a fraction of the budget. The DeepSeek app climbing Apple App Store rankings. The week of disbelief.
...
### Episode 7: The Lieutenant — Mira Murati's Weekend as CEO
*Hao Empire of AI chapters on Murati + post-departure reporting on Thinking Machines Lab.* November 17-22 2023. The 72 hours when Mira Murati was OpenAI's interim CEO. The phone calls. The Microsoft contingency planning. The decision to threaten resignation alongside Altman. The cost to her career. Her September 2024 departure from OpenAI. Her new company Thinking Machines Lab and what it represents.

### Episode 8: The Bet — Microsoft and the $13 Billion Decision
*Bloomberg + Hao chapters on Microsoft-OpenAI partnership.* Satya Nadella's January 2023 decision to commit billions to OpenAI. The internal Microsoft debate. The Steve Ballmer "Yahoo bid all over again" framing inside Redmond. The November 2023 weekend when Nadella saved OpenAI by offering to hire Altman and his team. The strategic vindication. The 2026 valuation implications.

### Episode 9: The Heretic — Geoffrey Hinton's Resignation
*Cade Metz NYT reporting + Hinton's public statements + post-Nobel coverage.* April 2023. Hinton resigns from Google to speak freely about AI risks. The "godfather of AI" public turn. His 2024 Nobel Prize. The doomer-laureate position. The eight months between resignation and Nobel that reshaped public AI discourse. Visualizable: Hinton's Toronto office, the Google labs he left, the Nobel ceremony in Stockholm.

### Episode 10: The Charter — How OpenAI Stopped Being a Nonprofit
*Hao Empire of AI as primary source + Musk trial transcripts now public.* The 2019 capped-profit structure. The 2024 announcement to fully convert to for-profit. The legal mechanism. The $852 billion valuation. What the original 2015 founding documents actually said. The Musk lawsuit foundation. The 2026 trial verdict. The philosophical question: can a company built to serve humanity convert to one built to serve shareholders?

### Cumulative pipeline implications

10 episodes × ~1 week production cadence = 10-12 weeks of runway from launch. By Episode 6-7, the channel should have its first audience signal back from the algorithm. By Episode 10, either the back-catalogue is compounding or the channel needs strategic adjustment.

After Episode 10, the pipeline opens to: the Anthropic deep-dive (Constitutional AI, Claude development, safety research), the DeepMind side (Hassabis, AlphaGo, the Google merger drama), the Meta side (Yann LeCun, the open-source Llama bet), the xAI side (Musk's post-departure arc, Grok launches, the appeal verdict), the China side (export controls, the geopolitics), the AI safety researcher community (Bengio, Russell, the policy debate).
...
- **21 views** (one new subscriber)
- **545 impressions, 2.2% CTR**
- **AVD 3:42 = 23.3% of 16-minute runtime**
- **Watch time 1.3 hours**
- **Curve shape:** sharp rise in hours 1-3, then flatline
...
- Pin a comment asking viewers about Arthur Stanley Briggs and his later life (engagement-rate boost)
- Post a Community tab post with a hook detail (the empty lifeboat davits, the dates of the family's later tragedies)
- Resist publishing another Final Hours video for 48 hours — let the algorithm read Mary Celeste's signal cleanly
