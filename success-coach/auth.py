...
Run this ONCE. It opens a browser, asks you to log in to peteralkema6@gmail.com,
...
def main():
    ...
    print("A browser window will open. Log in to peteralkema6@gmail.com,")
    print("and IMPORTANTLY: pick the 'Success Coach' channel from the chooser,")
    print("\n")
    ...
    print("This token is now bound to the Success Coach channel. The upload script")
